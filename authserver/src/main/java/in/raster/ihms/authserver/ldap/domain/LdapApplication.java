...
/**
 * Custom class to map application object from ldap.
 */
@Entry(objectClasses = {"top", "ihmsApplication"})
public class LdapApplication {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LdapApplication)) return false;
        LdapApplication that = (LdapApplication) o;
